...
static const USBDescriptor tmcemu_device_descriptor = {
    sizeof tmcemu_device_descriptor_data, tmcemu_device_descriptor_data};

static const USBDescriptor dpo3034_device_descriptor = {
    sizeof dpo3034_device_descriptor_data, dpo3034_device_descriptor_data};

static const USBDescriptor dso9404a_device_descriptor = {
    sizeof dso9404a_device_descriptor_data, dso9404a_device_descriptor_data};
...
static const uint8_t tmc_configuration_descriptor_data[39] = {
    ...
    USB_DESC_ENDPOINT(2 | 0x80, 0x03, /* bmAttributes (Interrupt).        */
...
static void    indicator_step(void *arg) {
    ...
    if (step < 4) {
        osalSysLockFromISR();
        chVTSetI(&indicator_vt, TIME_MS2I(250), indicator_step,
                 (void *)step + 1);
        osalSysUnlockFromISR();
    }
}
 ...
 */
const USBConfig usbcfg = {usb_event, get_descriptor, tmcRequestsHook,
                          sof_handler};

/*
 * Serial over USB driver configuration.
 */
const USBTMCConfig usbtmccfg = {&USBD1, TMC_BULK_IN_EP, TMC_BULK_OUT_EP,
                                TMC_INT_IN_EP, indicator_handler};
