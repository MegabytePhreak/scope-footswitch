...
#define DFU_IFACE_STRING  "@Internal Flash  /0x08000000/1*016Ka,3*016Kg,1*064Kg,1*128Kg"
...
static void
usbdfu_getstatus_complete(usbd_device *mydev, struct usb_setup_data *req)
{
	(void)req;
	(void)mydev;
...
static enum usbd_request_return_codes usbdfu_control_request(usbd_device *mydev,
