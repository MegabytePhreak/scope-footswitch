...
static int get_response(hid_device *handle, hidprog_response_t *rsp,
                        int timeout) {
...
static int run_command(hid_device *handle, hidprog_command_t *cmd,
...
static int program_flash(hid_device *handle, uint32_t base_address,
